import { integer, boolean, pgEnum, pgTable, primaryKey, text, timestamp, varchar, index, type AnyPgColumn } from "drizzle-orm/pg-core";
...
export const discussionReplies = pgTable("discussion_replies", {
    ...
    parentId: integer('parent_id').references((): AnyPgColumn => discussionReplies.id, { onDelete: 'cascade' }),
